...
public class TBAPlayerController : MonoBehaviour {
	...
	void OnTriggerEnter2D (Collider2D other) {
		if (other.tag == "Enemy") {
			...
			RedTBAPathfinding resetRed = GameObject.Find ("Red").GetComponent<RedTBAPathfinding> ();
			...
			PinkTBAPathfinding resetPink = GameObject.Find ("Pink").GetComponent<PinkTBAPathfinding> ();
			...
			BlueTBAPathfinding resetBlue = GameObject.Find ("Blue").GetComponent<BlueTBAPathfinding> ();
			...
			OrangeTBAPathfinding resetOrange = GameObject.Find ("Orange").GetComponent<OrangeTBAPathfinding> ();
